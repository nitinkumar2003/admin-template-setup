...
import GoalsIcon from './goal.svg'
import StyleIcon from './styles.svg'
import HomesGymIcon from './home-gym.svg'
import SubscriptionIcon from './subscription_icon.svg'
import TraningIcon from './training.svg'
import ChangePasswordIcon from './change-password.svg'
export {
  ChangePasswordIcon,
  TraningIcon,
  SubscriptionIcon,
